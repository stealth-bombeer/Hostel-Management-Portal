...
//   </p>
import { Link } from "react-router-dom";
import vjtipic1 from "./hostelpics/vjtipic1.jpeg";
import vjtipic2 from "./hostelpics/vjtipic2.jpeg";
import vjtipic3 from "./hostelpics/vjtipic3.jpeg";
  ...
  return (
    <>
      <div className="Home">
        <h2 id="pulsefit">Welcome to VJTI hostel Portal...</h2>
        <h4 id="pulsefit2">
          "Divided by cities, United by Hostel".....
          So come with lots of curiosity and zeal to have a sight of our hostel fam!!
        </h4>
        <div>
          {/* <Link to="./aboutus" is="aboutus">about us</Link> */}
        </div>
        <img className="homeBgImg" src={vjtipic1} alt="hostel pic 1" />
      </div>
