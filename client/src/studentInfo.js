    ...
    if (documentWithId2) {
        return (
            <div>
                ...
                <p className="fields">Academic Year (Institute): {documentWithId2.academicYear_institute}</p>
                <p className="fields">Academic Year (hostel): {documentWithId2.academicYear_hostel}</p>
                ...
                <p className="fields">Guardian Address: {documentWithId2.gaurdian_address}</p>
                <p className="fields">Guardian Number: {documentWithId2.gaurdian_Number}</p>
                <p className="fields">Gender: {documentWithId2.gender}</p>
                <p className="aadhar"> Aadhar Card:  <ImagePreview imageUrl={documentWithId2['aadhar']['url']} /></p>
